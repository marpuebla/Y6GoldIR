...
def plot_mag_histogram(file1, file2, file3):
    ...
    plt.hist(mag1, bins=37, color='red', alpha=0.6, label='DES+VHS', edgecolor='black')
    plt.hist(mag2, bins=37, color='green', alpha=0.6, label='DES+WISE', edgecolor='black')
    plt.hist(mag3, bins=37, color='yellow', alpha=0.6, label='DES+VHS+WISE', edgecolor='black')
