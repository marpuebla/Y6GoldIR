...
#python incertidumbres_wise.py anf_des_2.fits anf_des_wise_siny_2.fits anf_des_wise_2.fits
...
def calculate_means_and_errorsMAD(t, z_min, z_max):
...
print(f"Catalog 1 sigma (0.8-1.4): {sigma1:.4f} ± {sigma_err1:.4f}")
print(f"Catalog 2 sigma (0.2-0.8): {sigma2:.4f} ± {sigma_err2:.4f}")
print(f"Catalog 3 sigma (0.2-0.8): {sigma3:.4f} ± {sigma_err3:.4f}")
...
print(f"Catalog 1 sigma (0.2-1.4): {sigma1:.4f} ± {sigma_err1:.4f}")
print(f"Catalog 2 sigma (0.2-0.8): {sigma2:.4f} ± {sigma_err2:.4f}")
print(f"Catalog 3 sigma (0.2-0.8): {sigma3:.4f} ± {sigma_err3:.4f}")
...
print(f"Catalog 1 sigma68 (0.8-1.4): {sigma68_1:.4f} ± {sigma68_err1:.4f}")
print(f"Catalog 2 sigma68 (0.2-0.8): {sigma68_2:.4f} ± {sigma68_err2:.4f}")
print(f"Catalog 3 sigma68 (0.2-0.8): {sigma68_3:.4f} ± {sigma68_err3:.4f}")
...
print(f"Catalog 1 sigma68 (0.2-1.4): {sigma68_1:.4f} ± {sigma68_err1:.4f}")
print(f"Catalog 2 sigma68 (0.2-0.8): {sigma68_2:.4f} ± {sigma68_err2:.4f}")
print(f"Catalog 3 sigma68 (0.2-0.8): {sigma68_3:.4f} ± {sigma68_err3:.4f}")
"""
# === GUARDAR TODA LA ESTADÍSTICA EN UN TXT ===
...
# Copia aquí todos tus print como add(...)
...
# …añade aquí el resto de prints de MAD, sigma y sigma68
# Repite usando add() del mismo modo:
...
with open("estadisticas_resultados.txt", "w") as f:
    f.write(output_text)

print("\n>>> Archivo 'estadisticas_resultados.txt' generado correctamente.\n")
