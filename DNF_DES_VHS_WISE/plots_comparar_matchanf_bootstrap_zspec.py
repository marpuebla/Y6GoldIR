...
plt.errorbar(bin_centers_offset_3_MAD, meansMAD3, yerr=errorsMAD3, fmt='o', label='DES+WISE', color='green', capsize=4)
plt.errorbar(bin_centers_offset_4_MAD, meansMAD4, yerr=errorsMAD4, fmt='o', label='DES+VHS+WISE', color='orange', capsize=4)
plt.xlabel('Photo-z bin')
plt.ylabel(r'$\langle |z_\mathrm{photo} - z_\mathrm{spec}| \rangle$')
plt.legend(loc='best')
plt.grid()
plt.savefig('PRUEBAS/F_8_b_match.png', dpi=300)
#plt.show()
...
plt.errorbar(bin_centers_offset_3, sigma68_ratio3, yerr=sigma68_ratio_err3, fmt='o', label='DES+WISE', color='green', capsize=4)
plt.errorbar(bin_centers_offset_4, sigma68_ratio4, yerr=sigma68_ratio_err4, fmt='o', label='DES+VHS+WISE', color='orange', capsize=4)
plt.xlabel('Photo-z bin')
...
plt.errorbar(bin_centers_offset_3, outlier_fraction3_Banerji, yerr=outlier_errors3_Banerji, fmt='o', label='DES+WISE', color='green', capsize=4)
plt.errorbar(bin_centers_offset_4, outlier_fraction4_Banerji, yerr=outlier_errors4_Banerji, fmt='o', label='DES+VHS+WISE', color='orange', capsize=4)
plt.xlabel('Photo-z bin')
