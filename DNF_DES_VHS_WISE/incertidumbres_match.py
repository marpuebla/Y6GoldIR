...
#python incertidumbres_match.py anf_match_optico.fits anf_match_vhs.fits anf_match_wise.fits anf_match.fits
...
meansMAD4, errorsMAD4 = calculate_means_and_errorsMAD(t4,0.2,0.8)
...
print(f'Catalog 4 (filters {filters4}): MAD = {meansMAD4:.4f} ± {errorsMAD4:.4f}')
...
meansMAD4, errorsMAD4 = calculate_means_and_errorsMAD(t4,0.8,1.4)
...
meansMAD4, errorsMAD4 = calculate_means_and_errorsMAD(t4,0.2,1.4)
...
sigma4, sigma_err4 = calculate_sigma_global(t4)
...
print(f"Catalog 4 sigma (0.2-0.8): {sigma4:.4f} ± {sigma_err4:.4f}")
...
sigma4, sigma_err4 = calculate_sigma_global(t4,0.8,1.4)
print(f"Catalog 1 sigma (0.2-0.8): {sigma1:.4f} ± {sigma_err1:.4f}")
print(f"Catalog 2 sigma (0.2-0.8): {sigma2:.4f} ± {sigma_err2:.4f}")
print(f"Catalog 3 sigma (0.2-0.8): {sigma3:.4f} ± {sigma_err3:.4f}")
print(f"Catalog 4 sigma (0.2-0.8): {sigma4:.4f} ± {sigma_err4:.4f}")
...
sigma4, sigma_err4 = calculate_sigma_global(t4,0.2,1.4)
print(f"Catalog 1 sigma (0.2-0.8): {sigma1:.4f} ± {sigma_err1:.4f}")
print(f"Catalog 2 sigma (0.2-0.8): {sigma2:.4f} ± {sigma_err2:.4f}")
print(f"Catalog 3 sigma (0.2-0.8): {sigma3:.4f} ± {sigma_err3:.4f}")
print(f"Catalog 4 sigma (0.2-0.8): {sigma4:.4f} ± {sigma_err4:.4f}")
...
sigma68_4, sigma68_err4 = calculate_sigma68_global_with_error(t4)
...
print(f"Catalog 4 sigma68 (0.2-0.8): {sigma68_4:.4f} ± {sigma68_err4:.4f}")
...
sigma68_4, sigma68_err4 = calculate_sigma68_global_with_error(t4,0.8,1.4)
...
sigma68_4, sigma68_err4 = calculate_sigma68_global_with_error(t4,0.2,1.4)
...
# --- Sección longitudes ---
add(f"longitudes: {len(t1)} {len(t2)} {len(t3)} {len(t4)}")

# --- bias, sigma, sigma68 ---
add(f"bias: {bias1} {bias2} {bias3} {bias4}")
add(f"sigma: {sigma1} {sigma2} {sigma3} {sigma4}")
add(f"sigma68: {zerrsigma68_1} {zerrsigma68_2} {zerrsigma68_3} {zerrsigma68_4}")

# --- MAD (0.2 - 0.8) ---
add(f"Catalog 1 (filters {filters1}): MAD(0.2-0.8) = {meansMAD1:.4f} ± {errorsMAD1:.4f}")
add(f"Catalog 2 (filters {filters2}): MAD(0.2-0.8) = {meansMAD2:.4f} ± {errorsMAD2:.4f}")
add(f"Catalog 3 (filters {filters3}): MAD(0.2-0.8) = {meansMAD3:.4f} ± {errorsMAD3:.4f}")
add(f"Catalog 4 (filters {filters4}): MAD(0.2-0.8) = {meansMAD4:.4f} ± {errorsMAD4:.4f}")
...
add(f"Catalog 1 (filters {filters1}): MAD(0.8-1.4) = {meansMAD1:.4f} ± {errorsMAD1:.4f}")
add(f"Catalog 2 (filters {filters2}): MAD(0.8-1.4) = {meansMAD2:.4f} ± {errorsMAD2:.4f}")
add(f"Catalog 3 (filters {filters3}): MAD(0.8-1.4) = {meansMAD3:.4f} ± {errorsMAD3:.4f}")
add(f"Catalog 4 (filters {filters4}): MAD(0.8-1.4) = {meansMAD4:.4f} ± {errorsMAD4:.4f}")
...
add(f"Catalog 1 (filters {filters1}): MAD(0.2-1.4) = {meansMAD1:.4f} ± {errorsMAD1:.4f}")
add(f"Catalog 2 (filters {filters2}): MAD(0.2-1.4) = {meansMAD2:.4f} ± {errorsMAD2:.4f}")
add(f"Catalog 3 (filters {filters3}): MAD(0.2-1.4) = {meansMAD3:.4f} ± {errorsMAD3:.4f}")
add(f"Catalog 4 (filters {filters4}): MAD(0.2-1.4) = {meansMAD4:.4f} ± {errorsMAD4:.4f}")

# --- Sigma global (0.2 - 0.8) ---
add(f"Catalog 1 sigma (0.2-0.8): {sigma1:.4f} ± {sigma_err1:.4f}")
add(f"Catalog 2 sigma (0.2-0.8): {sigma2:.4f} ± {sigma_err2:.4f}")
add(f"Catalog 3 sigma (0.2-0.8): {sigma3:.4f} ± {sigma_err3:.4f}")
add(f"Catalog 4 sigma (0.2-0.8): {sigma4:.4f} ± {sigma_err4:.4f}")

# --- Sigma global (0.8 - 1.4) ---
sigma1, sigma_err1 = calculate_sigma_global(t1,0.8,1.4)
sigma2, sigma_err2 = calculate_sigma_global(t2,0.8,1.4)
sigma3, sigma_err3 = calculate_sigma_global(t3,0.8,1.4)
sigma4, sigma_err4 = calculate_sigma_global(t4,0.8,1.4)

add(f"Catalog 1 sigma (0.8-1.4): {sigma1:.4f} ± {sigma_err1:.4f}")
add(f"Catalog 2 sigma (0.8-1.4): {sigma2:.4f} ± {sigma_err2:.4f}")
add(f"Catalog 3 sigma (0.8-1.4): {sigma3:.4f} ± {sigma_err3:.4f}")
add(f"Catalog 4 sigma (0.8-1.4): {sigma4:.4f} ± {sigma_err4:.4f}")

# --- Sigma global (0.2 - 1.4) ---
sigma1, sigma_err1 = calculate_sigma_global(t1,0.2,1.4)
sigma2, sigma_err2 = calculate_sigma_global(t2,0.2,1.4)
sigma3, sigma_err3 = calculate_sigma_global(t3,0.2,1.4)
sigma4, sigma_err4 = calculate_sigma_global(t4,0.2,1.4)

add(f"Catalog 1 sigma (0.2-1.4): {sigma1:.4f} ± {sigma_err1:.4f}")
add(f"Catalog 2 sigma (0.2-1.4): {sigma2:.4f} ± {sigma_err2:.4f}")
add(f"Catalog 3 sigma (0.2-1.4): {sigma3:.4f} ± {sigma_err3:.4f}")
add(f"Catalog 4 sigma (0.2-1.4): {sigma4:.4f} ± {sigma_err4:.4f}")

# --- Sigma68 global (0.2 - 0.8) ---
add(f"Catalog 1 sigma68 (0.2-0.8): {sigma68_1:.4f} ± {sigma68_err1:.4f}")
add(f"Catalog 2 sigma68 (0.2-0.8): {sigma68_2:.4f} ± {sigma68_err2:.4f}")
add(f"Catalog 3 sigma68 (0.2-0.8): {sigma68_3:.4f} ± {sigma68_err3:.4f}")
add(f"Catalog 4 sigma68 (0.2-0.8): {sigma68_4:.4f} ± {sigma68_err4:.4f}")

# --- Sigma68 global (0.8 - 1.4) ---
sigma68_1, sigma68_err1 = calculate_sigma68_global_with_error(t1,0.8,1.4)
sigma68_2, sigma68_err2 = calculate_sigma68_global_with_error(t2,0.8,1.4)
sigma68_3, sigma68_err3 = calculate_sigma68_global_with_error(t3,0.8,1.4)
sigma68_4, sigma68_err4 = calculate_sigma68_global_with_error(t4,0.8,1.4)

add(f"Catalog 1 sigma68 (0.8-1.4): {sigma68_1:.4f} ± {sigma68_err1:.4f}")
add(f"Catalog 2 sigma68 (0.8-1.4): {sigma68_2:.4f} ± {sigma68_err2:.4f}")
add(f"Catalog 3 sigma68 (0.8-1.4): {sigma68_3:.4f} ± {sigma68_err3:.4f}")
add(f"Catalog 4 sigma68 (0.8-1.4): {sigma68_4:.4f} ± {sigma68_err4:.4f}")

# --- Sigma68 global (0.2 - 1.4) ---
sigma68_1, sigma68_err1 = calculate_sigma68_global_with_error(t1,0.2,1.4)
sigma68_2, sigma68_err2 = calculate_sigma68_global_with_error(t2,0.2,1.4)
sigma68_3, sigma68_err3 = calculate_sigma68_global_with_error(t3,0.2,1.4)
sigma68_4, sigma68_err4 = calculate_sigma68_global_with_error(t4,0.2,1.4)

add(f"Catalog 1 sigma68 (0.2-1.4): {sigma68_1:.4f} ± {sigma68_err1:.4f}")
add(f"Catalog 2 sigma68 (0.2-1.4): {sigma68_2:.4f} ± {sigma68_err2:.4f}")
add(f"Catalog 3 sigma68 (0.2-1.4): {sigma68_3:.4f} ± {sigma68_err3:.4f}")
add(f"Catalog 4 sigma68 (0.2-1.4): {sigma68_4:.4f} ± {sigma68_err4:.4f}")

# --- Generar archivo ---
with open("results_incert_des_vhs_wise.txt", "w") as f:
    f.write(output_text)

print("\n>>> Archivo 'results_incert_des_vhs_wise.txt' generado correctamente.\n")
