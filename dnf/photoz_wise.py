#!/usr/bin/python
##### Modificado por Marina para incluir los filtros de WISE en el IR, w1,w2,w3,w4, con nombres de entrada igual que los de DES
#Author: Juan de Vicente
#17/01/2015
#photoz.py
#v 1.0
#Usage: python photoz_wise.py
...
#cambio el número de filtros
#parameters
nfilters=7


#####reading training file ######################
### este será el primer archivo que se ponga, el que hace de training

GALAXY=Table.read(sys.argv[1]) #'Y1SPEC_MATCH2as_Y1Goldv103.fits')
#GALAXY=GALAXY[:14770]  #este corte luego se quitará
...
#añado los nuevos filtros y sus errores
...
G[:,5]=GALAXY['BDF_MAG_W1_CORRECTED']
G[:,6]=GALAXY['BDF_MAG_W2_CORRECTED']
#G[:,7]=GALAXY['BDF_MAG_W4_CORRECTED']
#G[:,8]=GALAXY['BDF_MAG_Y_CORRECTED']
...
Gerr[:,5]=GALAXY['BDF_MAG_ERR_W1']
Gerr[:,6]=GALAXY['BDF_MAG_ERR_W2']
#Gerr[:,7]=GALAXY['BDF_MAG_ERR_W4']
#Gerr[:,8]=GALAXY['BDF_MAG_ERR_Y']
#Gerr[:,]=GALAXY['BDF_T_ERR']
...
G[:,5]=GALAXY['BDF_MAG_W1_CORRECTED']
G[:,6]=GALAXY['BDF_MAG_W2_CORRECTED']
#G[:,4]=GALAXY['BDF_MAG_W1_CORRECTED']
#G[:,5]=GALAXY['BDF_MAG_W2_CORRECTED']
#G[:,6]=GALAXY['BDF_MAG_W3_CORRECTED']
#G[:,7]=GALAXY['BDF_MAG_W4_CORRECTED']
#G[:,8]=GALAXY['BDF_MAG_Y_CORRECTED']
#G[:,5]=GALAXY['BDF_T']
...
Gerr[:,5]=GALAXY['BDF_MAG_ERR_W1']
Gerr[:,6]=GALAXY['BDF_MAG_ERR_W2']
#Gerr[:,4]=GALAXY['BDF_MAG_ERR_W1']
#Gerr[:,5]=GALAXY['BDF_MAG_ERR_W2']
#Gerr[:,6]=GALAXY['BDF_MAG_ERR_W3']
#Gerr[:,7]=GALAXY['BDF_MAG_ERR_W4']
#Gerr[:,8]=GALAXY['BDF_MAG_ERR_Y']
