...
#python incertidumbres_vhs.py anf_vhs_bandas_optico_corregido.fits anf_vhs_corregido.fits anf_vhs_JKs.fits
...
# Añadir toda la información impresa:

add(f'longitudes: {len(t1)} {len(t2)} {len(t3)}')
add(f'bias: {bias1} {bias2} {bias3}')
add(f'sigma: {sigma1} {sigma2} {sigma3}')
add(f'sigma68: {zerrsigma68_1} {zerrsigma68_2} {zerrsigma68_3}')
...
# Guardar archivo
with open("resultados_incert_vhs.txt", "w") as f:
    f.write(output_text)

print("\n>>> Archivo 'resultados_incert_vhs.txt' generado correctamente.\n")
